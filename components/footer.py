        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 32px; margin-bottom: 28px;">
            <div>
                <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;">
                    ...
                    <span style="font-size: 1.5rem; font-weight: 950; color: #ffffff;">CAVI</span>
                </div>
                <div style="font-size: 1.15rem; font-weight: 800; color: #38bdf8; margin-bottom: 8px;">
                    {get_text('app_full_name', lang)}
                </div>
                <p style="font-size: 1.0rem; color: #94a3b8; line-height: 1.6; margin-bottom: 12px;">
                    "{get_text('tagline', lang)}"
                </p>
                <div style="font-size: 0.92rem; color: #cbd5e1; font-weight: 700;">
                    {csp_title}
                </div>
            </div>

            <div>
                <div style="font-size: 1.2rem; font-weight: 900; color: #ffffff; margin-bottom: 16px;">
                    {em_heading}
                </div>
                <div style="margin-bottom: 12px;">
                    <div style="font-size: 0.88rem; color: #94a3b8; margin-bottom: 2px;">{nat_helpline}</div>
                    <a href="tel:1930" style="color: #f87171; font-weight: 950; font-size: 1.6rem; text-decoration: none; display: inline-flex; align-items: center; gap: 6px;">
                        <span>📞</span> <span>1930 (24x7)</span>
                    </a>
                </div>
                <div style="margin-bottom: 12px;">
                    <div style="font-size: 0.88rem; color: #94a3b8; margin-bottom: 2px;">{off_site}</div>
                    <a href="https://cybercrime.gov.in" target="_blank" style="color: #38bdf8; font-weight: 800; text-decoration: none; font-size: 1.05rem;">
                        🌐 cybercrime.gov.in ↗
                    </a>
                </div>
                <div style="font-size: 0.92rem; color: #94a3b8;">
                    పోలీస్ ఎమర్జెన్సీ / Police Emergency: <b>112 / 100</b>
                </div>
            </div>
            ...
            <div>
                ...
                <div style="font-size: 1.0rem; color: #cbd5e1; line-height: 2.0;">
                    <div>🛡️ <b>జాగ్రత్తగా ఉండండి</b> (Stay Alert)</div>
                    <div>📱 <b>భద్రంగా ఉండండి</b> (Stay Safe)</div>
                    <div>🚨 <b>1930 కి కాల్ చేయండి</b> (Report Fraud Early)</div>
                    <div>🤝 <b>గ్రామస్తులకు వివరించండి</b> (Spread Awareness)</div>
                </div>
            </div>
        </div>

        <hr style="border: none; border-top: 1px solid rgba(255,255,255,0.12); margin: 24px 0 18px 0;">

        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 14px; font-size: 0.92rem; color: #94a3b8;">
            <div>
